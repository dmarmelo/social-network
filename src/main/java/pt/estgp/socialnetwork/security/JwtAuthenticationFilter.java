...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    However, Loading the current details of the user from the database might still be helpful. For example, you might wanna disallow
    login with this JWT if the user’s role has changed, or the user has updated his password after the creation of this JWT. */
    @Override
